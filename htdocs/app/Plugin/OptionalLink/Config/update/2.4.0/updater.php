<?php
/**
 * OptionalLink 2.4.0 バージョン アップデートスクリプト
 *
 * ----------------------------------------
 * 　アップデートの仕様について
 * ----------------------------------------
 ...
 */
	if ($this->loadSchema('2.4.0', 'OptionalLinkConfig', '', 'alter')){
		$this->setUpdateLog('optional_link_configs テーブルの構造変更に成功しました。');
	} else {
		$this->setUpdateLog('optional_link_configs テーブルの構造変更に失敗しました。', true);
	}
