...
<body>
        ...
        <div class="gNavInner">
          <div class="gNav-btnGroup">
            <div class="gNav-btn gNav-btn__login">
              ...
              <button type="submit" data-bca-btn-type="login" id="BtnLogin">ログイン</button>
            </div>
    ...
    <div role="main" class="top">
        ...
        <div class="top-kvInner">
          <div class="top-kv-txt">
            <picture class="top-kv-txt-catch">
              <source srcset="img/top/kv_catch_sp.svg" media="(max-width: 1023px)">
              <img src="/img/top/kv_catch.svg" alt="ランディングページ制作支援ツール インスタントページ" class="imgFit">
            </picture>
          ...
          <div class="top-kv-img">
            <img src="/img/top/kv_animation.gif" alt="" class="imgFit">
          </div>
        </div>
          ...
          <div class="top-lead-movieBlock">
            <div class="top-lead-movieBlockInner">
              <div class="top-lead-movieBlock-videoWrap">
                <video src="/img/top/lead_mv_system-operation.mp4" autoplay muted playsinline loop class="imgObjectFitCover"></video>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="top-recommend-caseBoxContainer">
            ...
            <section class="caseBox">
              ...
              <div class="caseBox-img">
                <img src="/img/top/recommend_case_img_01.svg" width="280" height="190" alt="" class="imgFit" loading="lazy">
              </div>
              <p class="caseBox-cf">
            ...
            <section class="caseBox">
              ...
              <div class="caseBox-img">
                <img src="/img/top/recommend_case_img_02.svg" width="280" height="190" alt="" class="imgFit" loading="lazy">
              </div>
              <p class="caseBox-cf">
                （例）量販・流通の販促ご担当者様
              </p>
            ...
            <section class="caseBox">
              ...
              <div class="caseBox-img">
                <img src="/img/top/recommend_case_img_03.svg" width="280" height="190" alt="" class="imgFit" loading="lazy">
              </div>
              <p class="caseBox-cf">
            ...
            <section class="caseBox">
              ...
              <div class="caseBox-img">
                <img src="/img/top/recommend_case_img_04.svg" width="280" height="190" alt="" class="imgFit" loading="lazy">
              </div>
              <p class="caseBox-cf">
            ...
            <section class="caseBox">
              ...
              <div class="caseBox-img">
                <img src="/img/top/recommend_case_img_05.svg" width="280" height="190" alt="" class="imgFit" loading="lazy">
              </div>
              <p class="caseBox-cf">
                <span class="noWrap">（例）WEBサイト制作会社様／</span><span class="noWrap">広告代理店様／コンサルティング会社様</span>
              </p>
            ...
            <section class="caseBox">
              ...
              <div class="caseBox-img">
                <img src="/img/top/recommend_case_img_06.svg" width="280" height="190" alt="" class="imgFit" loading="lazy">
              </div>
              <p class="caseBox-cf">
                <span class="noWrap">（例）WEBサイト制作会社様／</span><span class="noWrap">広告代理店様／コンサルティング会社様</span>
              </p>
            ...
            <div class="top-features-featuresBoxContainer">
                ...
                <div class="featuresBox-body">
                  <div class="featuresBox-body-img">
                    <div class="featuresBox-body-imgInner">
                      <img src="/img/top/feature_img_01.svg" width="338" height="262" alt="" class="imgFit" loading="lazy">
                    </div>
                  </div>
              ...
              <section class="featuresBox">
                ...
                <div class="featuresBox-body">
                  <div class="featuresBox-body-img">
                    <div class="featuresBox-body-imgInner">
                      <img src="/img/top/feature_img_02.svg" width="338" height="262" alt="" class="imgFit" loading="lazy">
                    </div>
                  </div>
                  <div class="featuresBox-body-txt">
              ...
              <section class="featuresBox">
                ...
                <div class="featuresBox-body">
                  <div class="featuresBox-body-img">
                    <div class="featuresBox-body-imgInner">
                      <img src="/img/top/feature_img_03.svg" width="338" height="262" alt="" class="imgFit" loading="lazy">
                    </div>
                  </div>
                  <div class="featuresBox-body-txt">
      ...
      <section class="top-news">
        <div class="l-smallContainer top-newsInner">
          ...
          <a href="#" class="top-btn top-news-moreBtn">
      ...
      <!-- CONTACT ※ CMS組込み時Element化 or Layoutファイルへ記述し下層へも適用 -->
      <div class="mod-contact">
        <div class="mod-contactInner">
          <div class="l-smallContainer mod-contact-contents">
            <p class="contents-catch">
  ...
  <footer role="contentinfo" class="footer">
    <div class="l-smallContainer footerInner">
      <div class="footer-contents">
        <a href="index.html" class="footer-contents-logo">
        ...
        <ul class="footer-contents-menu">
          ...
          <li class="listItem">
            <a href="#" class="listItemInner">機能紹介</a>
          </li>
          <li class="listItem">
            <a href="#" class="listItemInner">プラン紹介</a>
          </li>
          <li class="listItem">
            <a href="#" class="listItemInner">お知らせ</a>
          </li>
          <li class="listItem">
            <a href="#" class="listItemInner">プライバシーポリシー</a>
          </li>
          <li class="listItem">
            <a href="#" class="listItemInner">お問い合わせ</a>
          </li>
        </ul>
      </div>
  ...
  <div class="pageTop-box">
    <div id="pageTop" class="pageTop">
      <img src="/img/common/btn_pgtop.png" alt="ページトップに戻る" class="imgFit">
    </div>
  </div>
  <!-- /PAGE TOP BTN -->
