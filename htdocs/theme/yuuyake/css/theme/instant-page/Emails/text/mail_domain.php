...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
　　　　　　　　◆◇　<?php echo __d('baser', 'ドメイン取得申請を受け付けました')?>　◇◆
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

<?php if ($other['mode'] === 'user'): ?>
　<?php echo __d('baser', 'この度は、ドメイン取得申請いただきありがとうございます。')?>　
　<?php echo __d('baser', '送信内容は下記のようになっております。')?>　
<?php elseif ($other['mode'] === 'admin'): ?>
　<?php echo sprintf(__d('baser', '%s へのドメイン取得申請を受け付けました。'), $mailConfig['site_name']) ?>　
　<?php echo __d('baser', '受信内容は下記のとおりです。')?>　
<?php endif; ?>

━━━━◇◆━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
　◆ <?php echo __d('baser', 'ドメイン取得申請内容')?>　
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━◆◇━━━━
